...
<template>
    <div id="app" class="mx-container auto w-screen h-screen bg-red-200 flex justify-center overflow-clip ">
      <div class=""><!--#TODO: Make SearchBox component with the contents of this div-->
      <input v-model="query" type="text" placeholder="Search for a song on Spotify">
      <button @click="search">Search</button>
    </div>
      <div id="results" v-if="results.length > 0" class="overflow-scroll max-h-screen pt-10">
